...
| 2 | `npm test -w apps/hub` | 11파일 · **247/247** | 12파일 · **287/287** (+40) | 0 | ✅ 증가 |
| 3 | `npm run typecheck -w apps/hub` | 오류 0 | 오류 **0** | 0 | ✅ |
| 4 | `npm run test:mutation -w apps/hub` | **27/27** | **36/36** 검출 · 미검출 0 (+9) | 0 | ✅ 증가 |
| 5 | `npm run test:bundle -w apps/hub` | 9/9 · 금지 0건 | **9/9** · 금지 **0건** | 0 | ✅ 유지 |
| 6 | `npm run build:dry -w apps/hub` | 605.9 KiB | **616.8 KiB** (gzip 97.1) | 0 | 기록만 (+10.9 KiB) |
